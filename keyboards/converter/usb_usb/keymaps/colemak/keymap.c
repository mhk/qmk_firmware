...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_MHEN, KC_HANJ,   LT(1,KC_SPC),         KC_HAEN, KC_HENK, KC_KANA, KC_RALT, KC_RGUI, KC_APP,  KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT
    ),

    [_PROGKEYS] = LAYOUT_all(
                      ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,
    ______,           ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,              ______,______,______,    ______,______,______,______,    ______,
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  ______,  ______,     ______,______,______,    ______,______,______,______,    ______,______,
    KC_TAB,  KC_EXLM, KC_AT,   KC_PLUS, KC_LCBR, KC_TILD, ______,  KC_4,    KC_5,    KC_6,    KC_RCBR, KC_LBRC, KC_RBRC,          ______,     ______,______,______,    ______,______,______,______,    ______,______,
    KC_CAPS, KC_HASH, KC_DLR,  KC_EQL,  KC_LPRN, KC_GRV,  KC_0,    KC_1,    KC_2,    KC_3,    KC_RPRN, _______,          ______,  ______,                              ______,______,______,______,    ______,______,
    KC_LSFT, ______,  KC_PERC, KC_CIRC, KC_MINS, KC_LBRC, KC_PIPE, KC_AMPR, KC_7,    KC_8,    KC_9,    KC_RBRC,          ______,  ______,            ______,           ______,______,______,______,    ______,______,
    ______,  ______,  ______,  ______,  ______,         ______,             ______,  ______,  ______,  ______,  ______,  ______,  ______,     ______,______,______,    ______,       ______,______,    ______,______
    ),
